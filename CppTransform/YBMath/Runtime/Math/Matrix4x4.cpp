...
Matrix4x4f& Matrix4x4f::SetPerspective( 
	...
	float zFar )
{
	Get (0,0) = (2.0f * zNear) / (r - l); Get (0,1) = 0;                        Get (0,2) = (r + l) / (r - l);                Get (0,3) = 0;
	Get (1,0) = 0;                        Get (1,1) = (2.0f * zNear) / (t - b); Get (1,2) = (t + b) / (t - b);                Get (1,3) = 0;
	Get (2,0) = 0;                        Get (2,1) = 0;                        Get (2,2) = -(zFar + zNear) / (zFar - zNear); Get (2,3) = -(2.0f * zFar * zNear) / (zFar - zNear);
	Get (3,0) = 0;                        Get (3,1) = 0;                        Get (3,2) = -1.0f;                            Get (3,3) = 0;
